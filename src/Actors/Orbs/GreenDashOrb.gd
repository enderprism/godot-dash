...
func _ready() -> void:
	connect("green_dash_orb_entered", player, "_on_GreenDashOrb_area_entered", [rotation, reverse]) # connect orb function to player
	connect("green_dash_orb_exited", player, "_on_GreenDashOrb_area_exited") # connect orb function to player
