...
func _ready() -> void:
	connect("magenta_dash_orb_entered", player, "_on_MagentaDashOrb_area_entered", [rotation, reverse]) # connect orb function to player
	connect("magenta_dash_orb_exited", player, "_on_MagentaDashOrb_area_exited") # connect orb function to player
